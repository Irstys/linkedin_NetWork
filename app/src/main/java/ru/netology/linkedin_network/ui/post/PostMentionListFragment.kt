...
@AndroidEntryPoint
class PostMentionListFragment: Fragment() {
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).supportActionBar?.title = context?.getString(R.string.mentions)
        ...
        viewModel.mentorslist.observe(viewLifecycleOwner) {
