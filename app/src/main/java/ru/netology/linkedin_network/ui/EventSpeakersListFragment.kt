...
@AndroidEntryPoint
class EventSpeakersListFragment: Fragment() {
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).supportActionBar?.title = context?.getString(R.string.speakers)
        ...
        viewModel.speakerslist.observe(viewLifecycleOwner) {
