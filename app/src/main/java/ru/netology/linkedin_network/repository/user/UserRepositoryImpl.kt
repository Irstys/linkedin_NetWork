...
class UserRepositoryImpl @Inject constructor(
    ...
    override val data: MutableLiveData<List<User>> = userDao.getAllUsers().map(List<UserEntity>::toDto)  as MutableLiveData<List<User>>
    override val userData: MutableLiveData<User> = MutableLiveData(emptyUser)
